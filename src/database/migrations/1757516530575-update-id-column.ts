...
export class UpdateIdColumn1757516530575 implements MigrationInterface {
    name = 'UpdateIdColumn1757516530575'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "temporary_agendamentos" ("id" varchar PRIMARY KEY NOT NULL, "dataHora" datetime NOT NULL, "numeroContrato" varchar NOT NULL, "motoristaNome" varchar NOT NULL, "motoristaCpf" varchar NOT NULL, "placaCaminhao" varchar NOT NULL, "status" text NOT NULL DEFAULT ('pendente'), CONSTRAINT "UQ_4b96e5ee58e033f56ebf650c0e8" UNIQUE ("motoristaCpf"))`);
